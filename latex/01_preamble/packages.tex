...
\usepackage{import}
\usepackage{lmodern,textcomp} % latin modern (for €)
...
% There is also a package named 'graphics' - watch out! CTAN: http://www.ctan.org/pkg/graphicx
\usepackage{graphicx}
...
% \setlength{\textfloatsep}{2pt plus 2pt minus 2pt} % space left between floats
% \setlength{\textfloatsep}{10pt plus 2pt minus 4pt} % space between text and float
\usepackage{enumitem} % e.g. Less space: \begin{itemize}[noitemsep]
...
\usepackage[backend=bibtex8, style=authoryear, natbib=true, maxcitenames=2]{biblatex}
...
%Jeg ved ikke hvor denne pakke ellers skal være; 
\usepackage{verbatim}