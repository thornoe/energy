...
\label{subsec:d_spot}
We include the hour-by-hour spot market price on the day-ahead-market for the price region DK1 (Western Denmark) or DK2 (Eastern Denmark) depending on where the grid company is located (see section \ref{sec:theory}). The price is very volatile from day to day while having increased in 2018 as seen in figure \ref{fig:cons_price_time_series} (appendix \ref{app:data}).
\par
...
\begin{figure}[H]
  \centering
  \caption{Consumption, wind power prognosis and spot price by hour (business days)}
