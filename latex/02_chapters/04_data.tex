...
\label{subsec:d_time}
Year dummies as well as a time trend indicating the number of days since 2016-01-01 are included to account for growth, technological progress, or compositional changes that can affect electricity consumption other than the number of meters.
\medskip\\
DK bank holidays as well as a few other common holidays are identified in order to do sample split regressions for business days and non-business days (including weekends).
