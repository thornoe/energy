...
\begin{figure}
    ...
    \label{fig:merit}
    \def\svgwidth{150 mm }
    \input{03_figures/Merit Order Effect.pdf_tex}
\end{figure}
...
\subsection{Demand of electricity /Theory of demand-side response to electricity prices \todo{@Thor: Hvilken overskrift er bedst/mest rammende?}}
