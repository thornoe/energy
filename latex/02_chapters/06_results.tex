...
%Er der mere klogt at sige om de estimater?? /C
...
Even in the absence of large consumption changes there are still other advantages associated with demand responses such as real time pricing. While the current of limited exposure to price fluctuations is implicitly build to over-cater to peak demand without load shedding  --- . When prices are non-distorted they reflect the current state of the market and thus promotes adaption responses etc. .  This is under the assumption - problems exacerbated Even though demand may not respond too much; other advantages to real time pricing. Undistorted prices (at least in the absense of externalities - actually exacerbated when these are negative 
%Her afsnit om andre fordele ved RTP. RTP reflects the state of the market. Price caps % Higher exposure to .. Peaks (w. no price caps) also makes investments in storage more profitable => more research, maybe it will become economically feasible at some point in time. The current sstem is build to over-cater to peak demand without load shedding. 
