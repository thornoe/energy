...
\par
The t-tests and F-tests deem the wind power prognosis for DK2 to be a relevant instrument for the log spot price in DK1. On the contrary, the capacity constraints of the Great Belt Link becomes clear as the wind power prognosis for DK1 is not significant for the log spot price in DK2 while the wind power prognosis for Sweden is. 
\begin{table}[H]
\begin{threeparttable}
  \centering
