...
estout _all using "$results/ws_homoscedasticity.md", style(html) replace ///
	...
	prehead("###Table: Testing for homoscedasticity (log wholesale electricity consumption, business days, hours 11-15)<br>*Grid number 131 is EnergiMidt (in Western Denmark), grid number 791 is Radius (in Eastern Denmark)*<br><html><table>") ///
