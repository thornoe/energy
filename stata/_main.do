...
estout _all using "$results/ws_homoscedasticity.md", style(html) replace ///
	...
	prehead("**Table:** Testing for homoscedasticity (log wholesale electricity consumption, business days, hours 11-15)<br>*Grid company 131 is EnergiMidt (Western Denmark), grid company 791 is Radius (Eastern Denmark)*<br><html><table>") ///
